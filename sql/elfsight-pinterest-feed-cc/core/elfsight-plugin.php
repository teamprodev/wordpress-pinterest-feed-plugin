...
if (!class_exists('ElfsightPinterestFeedPlugin')) {
    class ElfsightPinterestFeedPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightPinterestFeedPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightPinterestFeedWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightPinterestFeedPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightPinterestFeedWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightPinterestFeedVCElement($config, $this->widgetsApi);
